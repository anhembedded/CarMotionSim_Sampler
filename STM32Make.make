...
Core/Src/Print.cpp \
Core/Src/main.cpp \
Core/Src/ufl_stm32f407_platform.cpp
...
GCC_PATH="C:/GCC-ARM-NONE-EABI-10-2020-Q4-MAJOR-WIN32/GCC-ARM-NONE-EABI-10-2020-Q4-MAJOR/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/OPENOCD-0.10.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/OPENOCD-0.10.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt;  mass_erase 0; exit"
